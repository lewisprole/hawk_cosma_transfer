  ...
  if(ThisTask == 0)
    {
      ...
      if(RestartSnapNum < 1000)
        sprintf(fname, "%sgroups_%03d/fof_subhalo_tab_%03d.0.hdf5", All.OutputDir, RestartSnapNum, RestartSnapNum);
      else
        sprintf(fname, "%sgroups_%03d/fof_subhalo_tab_%d.0.hdf5", All.OutputDir, RestartSnapNum, RestartSnapNum);
