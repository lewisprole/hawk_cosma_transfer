      ...
      if(i < NumPart)
      ...
      else
        {
          ...
          Tree_BhngbResultsImported[idx].Prop.BH_HaloVvir =
              dmax(Tree_BhngbResultsImported[idx].Prop.BH_HaloVvir, out->Prop.BH_HaloVvir);
          Tree_BhngbResultsImported[idx].Prop.BH_Mdot_radio =
              dmax(Tree_BhngbResultsImported[idx].Prop.BH_Mdot_radio, out->Prop.BH_Mdot_radio);
          Tree_BhngbResultsImported[idx].Prop.BH_Mdot_quasar =
              dmax(Tree_BhngbResultsImported[idx].Prop.BH_Mdot_quasar, out->Prop.BH_Mdot_quasar);
          ...
          Tree_BhngbResultsImported[idx].Prop.BH_RadioLum =
              dmax(Tree_BhngbResultsImported[idx].Prop.BH_RadioLum, out->Prop.BH_RadioLum);
#endif
