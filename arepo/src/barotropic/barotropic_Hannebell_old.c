...
void apply_barotropic_eos(void) /* normal cooling routine when star formation is disabled */
{
  ...
  for(idx = 0; idx < TimeBinsHydro.NActiveParticles; idx++)
	...
	*/
          ...
          /*Hannebelle*/
          t1=(2.4*1.673e-24/1.381e-16)*pow(0.2e5,2) * sqrt(1+pow(SphP[i].Density*1.991e-18/1e-13,(4./3.)));
	  SphP[i].Utherm = t1 * BOLTZMANN / PROTONMASS / 2.4 / (GAMMA - 1) / (All.UnitEnergy_in_cgs / All.UnitMass_in_g);
