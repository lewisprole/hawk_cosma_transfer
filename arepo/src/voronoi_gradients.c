 ...
 *
 *  Using the Green-Gauss method discribed in Springel et al. (2010).
 *
 *  \return void
 */
...
#endif /* #if defined(GRADIENTS_GREEN_GAUSS) && !defined(ONEDIMS) */

#endif /* #if defined(VORONOI) || (defined(AMR) && !defined(AMR_GRADIENTS)) */
