...
/*! \brief Factor for Zel'dovich displacement.
 *
...
/*! \brief Factor for second order lpt displacement and velocity correction.
 *
 *  \param[in] a Scale factor.
 *
 *  \return Correction factor.
...
/*! \brief Main routine for second order lpt ics.
 *
 *  \return void
 */
void second_order_ics(void)
{
  ...
  mpi_printf("fac1=%g  fac2=%g  fac3=%g\n", fac1, fac2, fac3);
