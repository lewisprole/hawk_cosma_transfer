 ...
 */
void opaleos_deinit_global() { opaleos_deinit_local(opal_table); }
...
int update_cache(struct opal_eos_table *opal_table, double x, double rho, double t)
{
  ...
  double mint = dmax(opal_table->mint[opal_table->cache->mrho], opal_table->mint[opal_table->cache->mrho + 1]);
