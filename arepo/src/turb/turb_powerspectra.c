...
void powerspec_turb(int filenr, int type)
{
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_ksgs_%03d.txt", All.OutputDir, filenr);
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_sgstadiab1_%03d.txt", All.OutputDir, filenr);
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_sgstadiab2_%03d.txt", All.OutputDir, filenr);
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_sgstturbprod1_%03d.txt", All.OutputDir, filenr);
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_sgstturbprod2_%03d.txt", All.OutputDir, filenr);
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_sgstviscdiss1_%03d.txt", All.OutputDir, filenr);
  ...
  if(type == 0)
    sprintf(fname, "%s/powerspec_sgstviscdiss2_%03d.txt", All.OutputDir, filenr);
