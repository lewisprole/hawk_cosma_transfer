...
#if defined(PMGRID) && \
    (!defined(PERIODIC) || defined(PLACEHIGHRESREGION) || defined(PLACEHIGHRESREGION) || defined(GRAVITY_NOT_PERIODIC))
...
#ifndef PERIODIC
  mpi_printf(
      "PM-NONPERIODIC: Allowed region for isolated PM mesh (coarse):   (%g|%g|%g)  -> (%g|%g|%g)   ext=%g  totmeshsize=%g  "
      "meshsize=%g\n\n",
      All.Xmintot[0][0], All.Xmintot[0][1], All.Xmintot[0][2], All.Xmaxtot[0][0], All.Xmaxtot[0][1], All.Xmaxtot[0][2], meshinner[0],
      All.TotalMeshSize[0], All.TotalMeshSize[0] / GRID);
#endif
#ifdef PLACEHIGHRESREGION
  mpi_printf(
