...
static void distribute_sph_particles(void)
{
  ...
  All.BunchSize =
      (int)((All.BufferSize * 1024 * 1024) /
            (sizeof(data_index) + sizeof(struct data_nodelist) + sizeof(struct distributedata_in) + sizeof(struct distributedata_out) +
             sizemax(sizeof(struct distributedata_in), sizeof(struct distributedata_out))));
