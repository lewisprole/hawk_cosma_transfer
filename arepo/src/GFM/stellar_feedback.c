...
void do_stellar_feedback(void)
{
  ...
  mpi_printf(
      "GFM_FEEDBACK: delayed cooling feedback (this step)  ---> number of kicked cells = %d, active stars (with SN explosions) = %d, "
      "kicked cells / star = %g\n",
  ...
  mpi_printf("GFM_FEEDBACK: delayed cooling feedback (this step)  ---> number of cells with deactivated cooling = %d\n",
             tot_no_cool_cells);
  mpi_printf(
      "GFM_FEEDBACK: delayed cooling feedback (this step)  ---> min blast radius (int units)= %g, max blast radius (int units)= %g\n",
      global_min_blast_radius, global_max_blast_radius);
  mpi_printf(
      "GFM_FEEDBACK: delayed cooling feedback (this step)  ---> as computed by feedback min shutoff time (int units)= %g, max shutoff "
      "time (int units)= %g\n",
      global_min_shut_time, global_max_shut_time);
  mpi_printf(
      "GFM_FEEDBACK: delayed cooling feedback (this step)  ---> as computed in SphP struct  min shutoff time (int units)= %g, max "
      "shutoff time (int units)= %g\n",
  ...
  mpi_printf(
      "GFM_FEEDBACK: kinetic feedback (this step)  ---> number of kicked cells = %d, active stars (with SN explosions) = %d, kicked "
      "cells / star = %g\n",
      sum_kicked_cells, tot_active_stars, kicked_cells_per_star);
  ...
  mpi_printf(
      "GFM_FEEDBACK: kinetic feedback (this step)  ---> total mass to kick = %g, total kicked mass = %g, avg mass kicked = %g\n",
