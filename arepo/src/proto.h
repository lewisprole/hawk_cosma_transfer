...
int subfind_contamination_treefind(MyDouble *searchcenter, MyFloat hsml, int target, int *startnode, int mode, int *nexport,
                                   int *nsend_local, double *Mass);
int subfind_ovderdens_treefind_dispersion(MyDouble searchcenter[3], MyFloat hsml, int target, int *startnode, int mode, int *nexport,
                                          int *nsend_local);
...
double subfind_ovderdens_treefind(MyDouble *searchcenter, MyFloat hsml, int target, int *startnode, int mode, int *nexport,
                                  int *nsend_local);
...
int subfind_ngb_treefind_nearesttwo(MyDouble *searchcenter, double hsml, int target, int *startnode, int mode, double *hmax,
...
void subfind_col_determine_sub_halo_properties(struct unbind_data *d, int num, double *mass, double *pos, double *vel, double *cm,
                                               double *veldisp, double *vmax, double *vmaxrad, double *spin, MyIDType *mostboundid,
                                               double *halfmassrad, double *submasstab);
void subfind_col_determine_R200(double hmr, double center[3], double *m_Mean200, double *r_Mean200, double *m_Crit200,
                                double *r_Crit200, double *m_TopHat, double *r_TopHat);
...
void subfind_add_grp_props_distribute_catalogue(void);
...
void calculate_enclosed_mass();
void relaxobject_free();
#endif
