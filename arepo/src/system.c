...
void determine_compute_nodes(void)
{
  ...
  list_of_nodes = (struct node_data *)malloc(
...
double measure_time(void) /* strategy: call this at end of functions to account for time in this function, and before another
