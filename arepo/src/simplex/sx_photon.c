 ...
 */
void sx_phot_initialize_global_directions()
{
#if (SX_NUM_ROT>0)
...
void sx_phot_initialize()
{
}

void sx_phot_start_run()
{
  // set solid angles
  for(int d=0; d<SX_NDIR; d++ ) 
    {
