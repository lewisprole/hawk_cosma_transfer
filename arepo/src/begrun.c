...
void begrun1(void)
{
  ...
  if(ASMTH == 0)
    terminate("ASMTH == 0 cannot be used with TreePM");
#endif
...
#endif /* #ifdef FM_STAR_FEEDBACK */

#if defined(USE_SFR) && !defined(FM_SFR) && !defined(LOCAL_FEEDBACK) && !defined(SFR_MCS)
  set_units_sfr();
#endif /* #if defined(USE_SFR) && !defined(FM_SFR) && !defined(LOCAL_FEEDBACK) */
