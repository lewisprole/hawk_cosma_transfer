  ...
  for(int i = 0; i < local_n; i++)
    {
      ...
      double Ekin_old = 0.5 * P[idx].Mass * (P[idx].Vel[0] * P[idx].Vel[0] + P[idx].Vel[1] * P[idx].Vel[1] + P[idx].Vel[2] * P[idx].Vel[2]);
      ...
      double Ekin_new = 0.5 * P[idx].Mass * (P[idx].Vel[0] * P[idx].Vel[0] + P[idx].Vel[1] * P[idx].Vel[1] + P[idx].Vel[2] * P[idx].Vel[2]);
