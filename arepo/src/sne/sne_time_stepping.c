  ...
  for(int i = 0; i < local_n; i++)
    {
      ...
      integertime ti_step = get_timestep_hydro(idx);
      timebins_get_bin_and_do_validity_checks(ti_step, &bin, P[idx].TimeBinHydro);

      int binoldHydro   = P[idx].TimeBinHydro;
      int binoldGravity = P[idx].TimeBinGrav;
