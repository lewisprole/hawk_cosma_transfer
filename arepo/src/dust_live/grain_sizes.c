...
double interval_overlap(double a_1, double b_1, double a_2, double b_2) { return dmax(0.0, dmin(b_1, b_2) - dmax(a_1, a_2)); }
...
double update_grain_sizes(int k, double adot, double dt, double dt_code)
{
  ...
  DTP(p).BinMassChgTau = dmin(DTP(p).BinMassChgTau, tau_gsd);
  return tau_gsd;
}
#endif
