...
#GMC_REFINEMENT
JEANS_REFINEMENT=16
#FIX_JEANS_TEMPERATURE=200
#THREE_BODY_H2_NOMERGE
...
NSOFTTYPES_HYDRO=120           # this is only relevant for ADAPTIVE_HYDRO_SOFTENING can can be set to override default value of 64
